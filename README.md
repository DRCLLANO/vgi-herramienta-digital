...
**Versión 2.10.9** · 43 escalas y un conversor de dosis equianalgésicas de opioides.
...
Herramienta con fines exclusivamente educativos y de investigación, sin
finalidad comercial, para el cálculo y la interpretación de escalas de
tamización. **No reemplaza la valoración clínica, el juicio profesional ni
...
versiones 2.10.6 a 2.10.9. [`SHA256SUMS.txt`](SHA256SUMS.txt) lista la suma SHA-256 de
...
> para la Valoración Geriátrica Integral (versión 2.10.9) [software]. Open Science
...
| `CHANGELOG.md` | Historial de versiones (1.0 a 2.10.9) |
...
| `verificacion/resultado-2.10.8.json` | Resultado fechado de esas pruebas sobre la versión 2.10.8 |
| `verificacion/resultado-2.10.9.json` | Resultado fechado de esas pruebas sobre la versión 2.10.9 |
