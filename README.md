...
**Versión 2.10.8** · 43 escalas y un conversor de dosis equianalgésicas de opioides.
...
versiones 2.10.6, 2.10.7 y 2.10.8. [`SHA256SUMS.txt`](SHA256SUMS.txt) lista la suma SHA-256 de
...
> para la Valoración Geriátrica Integral (versión 2.10.8) [software]. Open Science
...
| `CHANGELOG.md` | Historial de versiones (1.0 a 2.10.8) |
