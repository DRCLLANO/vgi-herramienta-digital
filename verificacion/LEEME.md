...
`resultado-2.10.6.json`, `resultado-2.10.7.json` y `resultado-2.10.8.json` son la
salida de este script sobre las versiones 2.10.6, 2.10.7 y 2.10.8; los recuentos
y la lista de fallos (vacía) son idénticos en las tres.
